...
import simpleTokenArtifact from "../shared/SimpleToken.json";
import contractAddress from "../shared/contract-address.json";
// import deployerAccount from "../shared/deployer.json";
...
export class Dapp extends React.Component {
  ...
  state = {
    ...
    // The user's address and balance
    selectedAddress: undefined,
    balance: undefined as undefined | bigint,
    // The ID about transactions being sent, and any possible error with them
    txBeingSent: undefined,
    deployBegin: undefined,
    transactionError: undefined,
  ...
  private _simpleToken: ethers.Contract;
  ...
  render() {
    ...
    if (!this.state.selectedAddress) {
      return <ConnectWallet onConnectWallet={a => this._initialize(a)} />;
    }
      ...
      <div className="container p-4">
        ...
        <div className="row">
          <div className="col-12">
            ...
            */}
            {!this.state.balance && <NoTokensMessage deployContract={() => this._deployContract()} />}
  ...
  async _intializeEthers() {
    ...
    this._simpleToken = new ethers.Contract(simpleTokenContractAddress, simpleTokenArtifact.abi, await this._provider.getSigner(0));
    console.log("_intializeEthers _simpleToken", this._simpleToken);
  ...
  async _getTokenData() {
    console.log("_getTokenData this._simpleToken", this._simpleToken);
  ...
  async _updateBalance() {
    ...
    console.log("_updateBalance balance", balance);
  ...
  async _transferTokens(to, amount) {
    ...
    try {
      ...
      console.log("typeof e", typeof error, Object.keys(error));
  ...
  async _deployContract() {
    ...
    await simpleTokenContract.waitForDeployment();

    simpleTokenContractAddress = await simpleTokenContract.getAddress();
    await this._intializeEthers();
